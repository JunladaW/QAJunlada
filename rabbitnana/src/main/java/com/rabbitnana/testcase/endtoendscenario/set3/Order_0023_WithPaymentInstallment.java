package com.rabbitnana.testcase.endtoendscenario.set3;
...
public class Order_0023_WithPaymentInstallment extends BaseClass {
	...
	@Test(dependsOnMethods = { "login_NANA" }, groups = { "END_TO_END_SET_3" })
	...
	@Test(dependsOnMethods = { "createLead_AssignToAgent" }, groups = { "END_TO_END_SET_3" })
	...
	@Test(dependsOnMethods = { "login_SaleAgent" }, groups = { "END_TO_END_SET_3" })
	...
	@Test(dependsOnMethods = { "searchSaleAgent_OrderID" }, groups = { "END_TO_END_SET_3" })
	...
	@Test(dependsOnMethods = { "fillSaleInfomation" }, groups = { "END_TO_END_SET_3" })
	...
	@Test(dependsOnMethods = { "readyToSubmit" }, groups = { "END_TO_END_SET_3" })
	...
	@Test(dependsOnMethods = { "insurerAccepted" }, groups = { "END_TO_END_SET_3" })
	...
	@Test(dependsOnMethods = { "shipmentProcess" }, groups = { "END_TO_END_SET_3" })
	...
	@Test(dependsOnMethods = { "closeOrder_Accounting" }, groups = { "END_TO_END_SET_3" })

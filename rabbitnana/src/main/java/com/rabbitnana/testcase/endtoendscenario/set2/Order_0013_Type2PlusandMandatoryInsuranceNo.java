...
public class Order_0013_Type2PlusandMandatoryInsuranceNo extends BaseClass {
	...
	@Test(dependsOnMethods = { "login_NANA" }, groups = { "END_TO_END_SET_2" })
	...
	@Test(dependsOnMethods = { "createLead_AssignToAgent" }, groups = { "END_TO_END_SET_2" })
	...
	@Test(dependsOnMethods = { "login_SaleAgent" }, groups = { "END_TO_END_SET_2" })
	...
	@Test(dependsOnMethods = { "searchSaleAgent_OrderID" }, groups = { "END_TO_END_SET_2" })
	...
	@Test(dependsOnMethods = { "fillSaleInfomation" }, groups = { "END_TO_END_SET_2" })
	...
	@Test(dependsOnMethods = { "readyToSubmit" }, groups = { "END_TO_END_SET_2" })
	...
	@Test(dependsOnMethods = { "insurerAccepted" }, groups = { "END_TO_END_SET_2" })
	...
	@Test(dependsOnMethods = { "shipmentProcess" }, groups = { "END_TO_END_SET_2" })
	...
	@Test(dependsOnMethods = { "closeOrder_Accounting" }, groups = { "END_TO_END_SET_2" })
